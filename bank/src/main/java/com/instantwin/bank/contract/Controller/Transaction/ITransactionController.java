...
public interface ITransactionController {
        ...
        ResponseEntity<List<TransactionSpecificUserView>> findTransactionsByUserId(@PathVariable long userId);
        ...
        ResponseEntity<TransactionDeleteView> deleteTransaction(@PathVariable long transactionId);
