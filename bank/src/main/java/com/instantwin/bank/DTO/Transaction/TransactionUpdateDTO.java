...
public record TransactionUpdateDTO(
        @Positive @Schema(description = "ID of user inside transaction. Can be updated but has to exist. Can't be null or < 1.", example = "123", requiredMode = Schema.RequiredMode.REQUIRED) long userId,
